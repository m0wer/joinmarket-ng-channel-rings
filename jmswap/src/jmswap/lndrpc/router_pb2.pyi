from . import lightning_pb2 as _lightning_pb2
...
class FailureDetail(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    INVOICE_ALREADY_SETTLED: _ClassVar[FailureDetail]
    HTLC_INVOICE_TYPE_MISMATCH: _ClassVar[FailureDetail]
    AMP_ERROR: _ClassVar[FailureDetail]
    AMP_RECONSTRUCTION: _ClassVar[FailureDetail]
    EXTERNAL_VALIDATION_FAILED: _ClassVar[FailureDetail]
...
INVOICE_ALREADY_SETTLED: FailureDetail
HTLC_INVOICE_TYPE_MISMATCH: FailureDetail
AMP_ERROR: FailureDetail
AMP_RECONSTRUCTION: FailureDetail
EXTERNAL_VALIDATION_FAILED: FailureDetail
...
class SendPaymentRequest(_message.Message):
    __slots__ = ("dest", "amt", "payment_hash", "final_cltv_delta", "payment_request", "timeout_seconds", "fee_limit_sat", "cltv_limit", "route_hints", "dest_custom_records", "amt_msat", "fee_limit_msat", "last_hop_pubkey", "allow_self_payment", "dest_features", "max_parts", "no_inflight_updates", "outgoing_chan_ids", "payment_addr", "max_shard_size_msat", "amp", "time_pref", "cancelable", "first_hop_custom_records")
    ...
    def __init__(self, dest: _Optional[bytes] = ..., amt: _Optional[int] = ..., payment_hash: _Optional[bytes] = ..., final_cltv_delta: _Optional[int] = ..., payment_request: _Optional[str] = ..., timeout_seconds: _Optional[int] = ..., fee_limit_sat: _Optional[int] = ..., cltv_limit: _Optional[int] = ..., route_hints: _Optional[_Iterable[_Union[_lightning_pb2.RouteHint, _Mapping]]] = ..., dest_custom_records: _Optional[_Mapping[int, bytes]] = ..., amt_msat: _Optional[int] = ..., fee_limit_msat: _Optional[int] = ..., last_hop_pubkey: _Optional[bytes] = ..., allow_self_payment: _Optional[bool] = ..., dest_features: _Optional[_Iterable[_Union[_lightning_pb2.FeatureBit, str]]] = ..., max_parts: _Optional[int] = ..., no_inflight_updates: _Optional[bool] = ..., outgoing_chan_ids: _Optional[_Iterable[int]] = ..., payment_addr: _Optional[bytes] = ..., max_shard_size_msat: _Optional[int] = ..., amp: _Optional[bool] = ..., time_pref: _Optional[float] = ..., cancelable: _Optional[bool] = ..., first_hop_custom_records: _Optional[_Mapping[int, bytes]] = ...) -> None: ...
...
class TrackPaymentRequest(_message.Message):
    ...
    payment_hash: bytes
    no_inflight_updates: bool
    def __init__(self, payment_hash: _Optional[bytes] = ..., no_inflight_updates: _Optional[bool] = ...) -> None: ...

class TrackPaymentsRequest(_message.Message):
    __slots__ = ("no_inflight_updates",)
    NO_INFLIGHT_UPDATES_FIELD_NUMBER: _ClassVar[int]
    no_inflight_updates: bool
    def __init__(self, no_inflight_updates: _Optional[bool] = ...) -> None: ...
...
class SendToRouteRequest(_message.Message):
    ...
    skip_temp_err: bool
    first_hop_custom_records: _containers.ScalarMap[int, bytes]
    def __init__(self, payment_hash: _Optional[bytes] = ..., route: _Optional[_Union[_lightning_pb2.Route, _Mapping]] = ..., skip_temp_err: _Optional[bool] = ..., first_hop_custom_records: _Optional[_Mapping[int, bytes]] = ...) -> None: ...
...
class XImportMissionControlRequest(_message.Message):
    ...
    pairs: _containers.RepeatedCompositeFieldContainer[PairHistory]
    force: bool
    def __init__(self, pairs: _Optional[_Iterable[_Union[PairHistory, _Mapping]]] = ..., force: _Optional[bool] = ...) -> None: ...
...
class ForwardHtlcInterceptRequest(_message.Message):
    __slots__ = ("incoming_circuit_key", "incoming_amount_msat", "incoming_expiry", "payment_hash", "outgoing_requested_chan_id", "outgoing_amount_msat", "outgoing_expiry", "custom_records", "onion_blob", "auto_fail_height", "in_wire_custom_records", "outgoing_requested_node_id")
    ...
    OUTGOING_REQUESTED_NODE_ID_FIELD_NUMBER: _ClassVar[int]
...
class DeleteForwardingHistoryRequest(_message.Message):
    __slots__ = ("delete_before_time", "delete_before_duration")
    DELETE_BEFORE_TIME_FIELD_NUMBER: _ClassVar[int]
    DELETE_BEFORE_DURATION_FIELD_NUMBER: _ClassVar[int]
    delete_before_time: int
    delete_before_duration: str
    def __init__(self, delete_before_time: _Optional[int] = ..., delete_before_duration: _Optional[str] = ...) -> None: ...

class DeleteForwardingHistoryResponse(_message.Message):
    __slots__ = ("events_deleted", "total_fee_msat", "status")
    EVENTS_DELETED_FIELD_NUMBER: _ClassVar[int]
    TOTAL_FEE_MSAT_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    events_deleted: int
    total_fee_msat: int
    status: str
    def __init__(self, events_deleted: _Optional[int] = ..., total_fee_msat: _Optional[int] = ..., status: _Optional[str] = ...) -> None: ...
